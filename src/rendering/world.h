...
namespace World {
    ...
    // Shadows
    // -----------------------------------------------------------------------
    inline float         shadowOpacity   = 0.6f;
    inline float         shadowSunOffset = 0.2f;
    inline float         shadowSizeScale = 2.5f;
    inline float         shadowMaxStretch= 3.0f;
    ...
    inline float         sunFadeStart     = 0.08f;
    ...
    inline float         windStrength  = 0.0f;
