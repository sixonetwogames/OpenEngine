...
namespace Materials {
    ...
    inline constexpr MaterialParams Tower     { {100,140,180,255}, 0.0f, 0.5f, true,   1.0f,  1.0f, 1.0f, false,  1.0f, 2.0f, 4.0f, false };
    ...
    inline constexpr MaterialParams Grass     { {130,160, 90,255}, 0.0f, 0.50f, true,   1.0f,  1.0f, 1.0f, true,   1.0f, 1.0f, 1.0f, false };
}
