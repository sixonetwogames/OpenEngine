...
namespace Materials {
    ...
    inline constexpr MaterialParams Tower     { {100,140,180,255}, 0.0f, 0.4f, true,   2.0f,  0.9f, 1.0f, false,  2.5f, 2.0f, 4.0f, false };
    ...
    inline constexpr MaterialParams Grass     { {130,160, 90,255}, 0.0f, 0.0f, true,  1.0f,  1.00f, 1.0f, true,   0.15f, 1.0f, 1.0f, false };
}
